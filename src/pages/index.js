...
const IndexPage = () => {
  ...
  query {
    image1: file(relativePath: { eq: "portfolio/fullsize/1.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 300) {
    ...
    image2: file(relativePath: { eq: "portfolio/fullsize/2.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 300) {
          ...GatsbyImageSharpFluid
        }
    ...
    image3: file(relativePath: { eq: "portfolio/fullsize/3.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 300) {
          ...GatsbyImageSharpFluid
        }
    ...
    image4: file(relativePath: { eq: "portfolio/fullsize/4.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 300) {
          ...GatsbyImageSharpFluid
        }
    ...
    image5: file(relativePath: { eq: "portfolio/fullsize/5.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 300) {
          ...GatsbyImageSharpFluid
        }
    ...
    image6: file(relativePath: { eq: "portfolio/fullsize/6.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 300) {
          ...GatsbyImageSharpFluid
        }
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              <p className="text-white-50 mb-4">Start Bootstrap has everything you need to get your new website up and
          ...
          <div className="row no-gutters">
            ...
            <div className="col-lg-4 col-sm-6">
              <a className="portfolio-box" href="images/portfolio/fullsize/4.jpg">
                <Img fluid={imageData.image4.childImageSharp.fluid}/>
                <div className="portfolio-box-caption">
                  <div className="project-category text-white-50">
                    Category
                  </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <a className="portfolio-box" href="img/portfolio/fullsize/5.jpg">
                <Img fluid={imageData.image5.childImageSharp.fluid}/>
                <div className="portfolio-box-caption">
                  <div className="project-category text-white-50">
                    Category
                  </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <a className="portfolio-box" href="img/portfolio/fullsize/6.jpg">
                <Img fluid={imageData.image6.childImageSharp.fluid}/>
